      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Estamos listos para escuchar tus necesidades y ofrecer las mejores soluciones 
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900">Representante Legal</h4>
                  <p className="text-gray-600">Oscar Danilo Mejía Escobar</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">saicoingenieria2018@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+57 320 695 7771</p>
                </div>
              </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-orange-50 rounded-lg border border-gray-200">
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Horarios de Atención</h4>
